...
export const POSITION_ALIASES: Record<string, string> = {
  frt: "front", fr: "front", f: "front",
  rr: "rear",
  lf: "left front", lr: "left rear",
  rf: "right front",
  lh: "left", lt: "left", l: "left",
  rh: "right", rt: "right",
  up: "upper", low: "lower",
  pass: "passenger", psgr: "passenger",
  drv: "driver",
  front: "front", rear: "rear", left: "left", right: "right",
  upper: "upper", lower: "lower", driver: "driver", passenger: "passenger",
};

/** Shorthand token expansions applied before matching. */
export const TOKEN_EXPANSIONS: Record<string, string> = {
  asy: "assembly", assy: "assembly", asm: "assembly",
  serp: "serpentine",
  cat: "catalytic",
  conv: "converter",
  alt: "alternator",
...
export const GENERIC_TOKENS = new Set([
  "set", "kit", "assembly", "pair", "front", "rear", "left", "right",
  "upper", "lower", "driver", "passenger", "side", "new", "oem", "and",
  "the", "a", "for", "with",
]);
...
export const PART_TAXONOMY: PartTaxonomyEntry[] = [
  ...
  {
    id: "brake_pad_set", label: "Brake pad set", category: "Brakes",
    aliases: ["brake pads", "pads", "brake pad", "pad set", "ceramic pads"],
    catalogPartIds: { front: "brake-pad-front", rear: "brake-pad-rear", default: "brake-pad-front" },
  },
  {
    id: "brake_rotor", label: "Brake rotor", category: "Brakes",
    aliases: ["rotor", "rotors", "brake disc", "disc rotor"],
    catalogPartIds: { front: "rotor-front", rear: "rotor-rear", default: "rotor-front" },
  },
  {
    id: "brake_caliper", label: "Brake caliper", category: "Brakes",
    aliases: ["caliper", "calipers"],
    catalogPartIds: { default: "brake-caliper" },
  },
  // ─── Filters (catalog-backed) ───
  {
    id: "oil_filter", label: "Oil filter", category: "Filters",
    aliases: ["oil filter"],
    catalogPartIds: { default: "oil-filter" },
  },
  {
    id: "air_filter", label: "Air filter", category: "Filters",
    aliases: ["air filter", "engine air filter"],
    catalogPartIds: { default: "air-filter" },
  },
  {
    id: "cabin_air_filter", label: "Cabin air filter", category: "Filters",
    aliases: ["cabin filter", "cabin air filter", "pollen filter", "ac filter"],
    catalogPartIds: { default: "cabin-air-filter" },
  },
  {
    id: "fuel_filter", label: "Fuel filter", category: "Filters",
    aliases: ["fuel filter", "gas filter"],
    catalogPartIds: { default: "fuel-filter" },
  },
  // ─── Ignition (catalog-backed) ───
  {
    id: "spark_plug_set", label: "Spark plug set", category: "Ignition",
    aliases: ["spark plugs", "plugs", "spark plug"],
    catalogPartIds: { default: "spark-plug-set" },
  },
  {
    id: "ignition_coil", label: "Ignition coil", category: "Ignition",
    aliases: ["coil", "coil pack", "ignition coil"],
    catalogPartIds: { default: "ignition-coil" },
  },
  {
    id: "distributor_cap", label: "Distributor cap", category: "Ignition",
  ...
  {
    id: "starter_motor", label: "Starter motor", category: "Electrical",
  ...
  {
    id: "oxygen_sensor", label: "Oxygen sensor", category: "Electrical",
  ...
  {
    id: "coolant_reservoir", label: "Coolant reservoir", category: "Cooling",
    aliases: ["coolant reservoir", "overflow tank", "expansion tank", "coolant tank"],
    catalogPartIds: { default: "coolant-reservoir" },
  },
  // ─── Lighting (catalog-backed) ───
  {
    id: "headlight_bulb", label: "Headlight bulb", category: "Lighting",
    aliases: ["headlight bulb", "h7 bulb", "headlamp bulb", "bulb"],
    catalogPartIds: { default: "h7-headlight" },
  },
  {
    id: "fog_light", label: "Fog light", category: "Lighting",
    aliases: ["fog light", "fog lamp", "h11 bulb", "fog light bulb"],
    catalogPartIds: { default: "h11-fog-light" },
  },
  // ─── Suspension (catalog-backed) ───
  {
    id: "sway_bar_link", label: "Sway bar link", category: "Suspension",
    aliases: ["sway bar link", "stabilizer link", "stab link", "end link"],
    catalogPartIds: { default: "sway-bar-link" },
  },
  {
    id: "control_arm", label: "Control arm", category: "Suspension",
    aliases: ["control arm", "a-arm", "wishbone"],
    catalogPartIds: { default: "control-arm" },
  },
  {
    id: "strut_assembly", label: "Strut assembly", category: "Suspension",
    aliases: ["strut", "struts", "strut assembly", "shock", "shock absorber", "coilover"],
    catalogPartIds: { default: "strut-assembly" },
  },
  {
    id: "tie_rod_end", label: "Tie rod end", category: "Suspension",
  ...
  {
    id: "serpentine_belt", label: "Serpentine belt", category: "Engine / Drivetrain",
    aliases: ["serpentine belt", "serp belt", "drive belt", "accessory belt", "fan belt"],
  },
  {
    id: "timing_belt", label: "Timing belt", category: "Engine / Drivetrain",
    aliases: ["timing belt", "timing chain", "cam belt"],
  },
  {
    id: "wheel_hub", label: "Wheel hub assembly", category: "Engine / Drivetrain",
    aliases: ["hub", "wheel hub", "hub assembly", "hub bearing", "wheel bearing"],
  },
  {
    id: "cv_axle", label: "CV axle", category: "Engine / Drivetrain",
    aliases: ["cv axle", "axle", "half shaft", "drive shaft", "cv joint"],
  },
  {
    id: "engine_mount", label: "Engine mount", category: "Engine / Drivetrain",
  ...
  {
    id: "muffler", label: "Muffler", category: "Exhaust",
    aliases: ["muffler", "silencer", "exhaust muffler"],
  },
  // ─── Body / Collision (not in demo catalog yet) ───
  {
    id: "fender_liner", label: "Fender liner", category: "Body / Collision",
    aliases: ["fender liner", "inner fender", "wheel well liner", "splash shield", "wheelhouse liner"],
  },
  {
    id: "fender", label: "Fender", category: "Body / Collision",
    aliases: ["fender", "wing"],
  },
  {
    id: "bumper_cover", label: "Bumper cover", category: "Body / Collision",
    aliases: ["bumper", "bumper cover", "front bumper", "rear bumper"],
  },
  {
    id: "headlight_assembly", label: "Headlight assembly", category: "Body / Collision",
    aliases: ["headlight", "headlamp", "headlight assembly", "headlamp assembly"],
  },
  {
    id: "side_mirror", label: "Side mirror", category: "Body / Collision",
    aliases: ["mirror", "side mirror", "door mirror", "wing mirror"],
  },
  {
    id: "grille", label: "Grille", category: "Body / Collision",
